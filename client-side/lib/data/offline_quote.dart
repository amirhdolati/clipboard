...
class OfflineQuote {
  ...
  OfflineQuote._privateConstructor();
  static final OfflineQuote _quote_instance = OfflineQuote._privateConstructor();

  factory OfflineQuote() {
    return _quote_instance;
  ...
  List<Map<String, dynamic>> get quote{
